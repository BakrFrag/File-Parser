...
class ParserHandler(object):
    ...
    def csv_handler(self, format, customer_file, vehicle_file):
        ...
        csv_customer_data = csv_parser.read_csv(
        ...
        csv_vehicle_data = csv_parser.read_csv(
    ...
    def xlsx_handler(self, format, customer_file, vehicle_file):
        ...
        xlsx_customer_data = xlsx_parser.read_xlsx(
        ...
        xlsx_vehicle_data = xlsx_parser.read_xlsx(
