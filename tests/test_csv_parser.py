...
class TestCsvParser(unittest.TestCase):
    ...
    def test_with_file_not_exist(self):
        ...
        function_result=csv_parser.read_csv(csv_parser.vehicles_file,kind="vehicle");
        ...
        function_result=csv_parser.read_csv(csv_parser.customers_file,kind="customer");
        self.assertEqual(function_result['error'],"file {} not exists".format(self.csv_customers_not_exist));
